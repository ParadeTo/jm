<template>
  ...
  <div class="app-container">
    <div class="filter-container">
        <el-input @keyup.enter.native="handleFilter" style="width: 200px;" placeholder="结算单号" v-model="query.number" />
        <el-date-picker
          placeholder="时间"
    ...
    <el-row style="margin-bottom: 20px;">
      <el-button type="primary" v-waves icon="el-icon-plus" @click="addOrder">新增结算单</el-button>
    </el-row>
